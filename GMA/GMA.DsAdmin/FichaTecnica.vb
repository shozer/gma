...
#Region " Listar "
    ...
    Public Function ListarFichaTecnica() As DataView
        ...
        Dim query As String = "Select cod_ficha_tecnica_fte, nom_projeto_pt_fte, nom_projeto_en_fte, nom_projeto_es_fte, des_projeto_pt_fte, des_projeto_en_fte, des_projeto_es_fte, des_programa_pt_fte, des_artigo_pt_fte, des_video_pt_fte, des_entrevista_pt_fte, des_livro_pt_fte "
...
#Region " Incluir "
    ...
    Public Function IncluirFichaTecnica(ByVal dsRegistro As DataSet) As Int32
        ...
        Dim query As String = "Insert into tb_gma_ficha_tecnica(nom_projeto_pt_fte, nom_projeto_en_fte, nom_projeto_es_fte, des_projeto_pt_fte, des_projeto_en_fte, des_projeto_es_fte, des_programa_pt_fte, des_artigo_pt_fte, des_video_pt_fte, des_entrevista_pt_fte, des_livro_pt_fte) "
        query &= "values(?nom_projeto_pt_fte, ?nom_projeto_en_fte, ?nom_projeto_es_fte, ?des_projeto_pt_fte, ?des_projeto_en_fte, ?des_projeto_es_fte, ?des_programa_pt_fte, ?des_artigo_pt_fte, ?des_video_pt_fte, ?des_entrevista_pt_fte, ?des_livro_pt_fte); SELECT LAST_INSERT_ID();"
