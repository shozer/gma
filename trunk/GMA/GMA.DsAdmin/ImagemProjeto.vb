...
#Region " Incluir "
    ...
    Public Function IncluirImagemProjeto(ByVal dsRegistro As DataSet) As Int32
        ...
        Dim query As String = "Insert into tb_gma_imagem_projeto(nom_imagem_projeto_ipr, cod_projeto_pro, nom_ordem_ipr) "
        query &= "values(?nom_imagem_projeto_ipr, ?cod_projeto_pro, ?nom_ordem_ipr); SELECT LAST_INSERT_ID();"
        ...
        Try
            ...
            command.Parameters.AddWithValue("?nom_ordem_ipr", dsRegistro.Tables(0).Rows(0)("nom_ordem_ipr"))
...
#Region " Alterar "
    ...
    Public Sub AlterarImagemProjeto(ByVal dsRegistro As DataSet)
        ...
        query &= "nom_ordem_ipr = ?nom_ordem_ipr "
        query &= "Where cod_imagem_projeto_ipr = ?cod_imagem_projeto_ipr "
