...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="campos">
        ...
        <div class="campo">
            <asp:TextBox ID="nom_cliente_cli" runat="server" Width="400px"></asp:TextBox>
        ...
        <div class="campo">
            <asp:TextBox ID="des_email_cli" runat="server" Width="400px"></asp:TextBox>
        ...
        <div class="campo">
            <asp:TextBox ID="des_login_cli" runat="server" Width="400px"></asp:TextBox><asp:RequiredFieldValidator
        ...
        <div class="campo">
            <asp:TextBox ID="des_senha_cli" runat="server" Width="400px" TextMode="Password"></asp:TextBox>
        </div>
        <div class="campo_titulo">
            Telefone:
        </div>
